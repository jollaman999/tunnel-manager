...
![Tunnel Manager: add a service port and a Host, approve the host key, reach the service through the tunnel, add a local forward, see both in the status screen, and turn on a SOCKS5 proxy](docs/demo.gif)
